...
例如：
```bash
python3 run_complete_workflow.py --data-dir "/Users/username/Bibliometrics/My_Research_Project"
```
...
### 数据位置
```
/path/to/data/My_Research_Project/
├── wos.txt
└── scopus.csv
```
...
**方式1：在脚本文件夹中运行**
```bash
cd ~/Desktop/scopus-wos-tools

python3 run_complete_workflow.py --data-dir "/path/to/data/My_Research_Project"
```

**方式2：使用绝对路径运行**
```bash
python3 ~/Desktop/scopus-wos-tools/run_complete_workflow.py \
...
数据目录: /Users/username/.../My_Research_Project
目标语言: English
