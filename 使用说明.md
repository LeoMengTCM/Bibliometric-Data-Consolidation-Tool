...
```bash
cd /Users/menglinghan/Desktop/多数据库
...
这将读取：`/Users/menglinghan/Desktop/多数据库/scopus.csv`
输出到：`/Users/menglinghan/Desktop/多数据库/scopus_converted_to_wos.txt`
...
```
✓ 转换完成！
✓ 输出文件: /Users/menglinghan/Desktop/多数据库/scopus_converted_to_wos.txt
✓ 共转换 3 条记录
```
...
```R
# 读取WOS格式文件
file <- "/Users/menglinghan/Desktop/多数据库/scopus_converted_to_wos.txt"
